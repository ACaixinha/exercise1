...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product" do
    assert_difference("Product.count") do
      post products_url, params: { product: { amount_available: @product.amount_available, cost: @product.cost, product_name: @product.product_name, seller_id: @product.seller_id } }, as: :json
    end
